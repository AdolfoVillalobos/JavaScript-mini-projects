...
var checkLimits = function checkLimits(city) {
  if (sc.length > 0) {
    var allowed = city === 'lisbon' ? allow.lisbon : allow.others;
...
var createDescription = function createDescription() {
  ...
  var description = "Order with ".concat(q, " ").concat(p, " ").concat(sc.length > 1 ? ', etc...' : '.');
  return description;
};
