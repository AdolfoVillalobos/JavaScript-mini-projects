...
const account2 = {
  ...
  movementsDates: [
    ...
    '2020-12-25T16:33:06.386Z',
    '2021-01-01T14:43:26.374Z',
    '2021-01-18T18:49:59.371Z',
    '2021-01-23T12:01:20.894Z',
  ],
  currency: 'USD',
  locale: 'en-US',
};
...
// console.log(25 ** (1 / 3));
// console.log(Math.pow(25, 1 / 3));
// console.log(Math.max(5, 18));
// console.log(Math.PI * Number.parseFloat('10px') ** 2);

// console.log(Math.trunc(Math.random() * 6 + 1));

// console.log((2.87658439).toFixed(2));
...
// console.log(new Date(2021, 1, 24, 6, 27, 32));
...
const pizzaTimer = setTimeout(
  (i1, i2) => console.log(`Here is your pizza with ${i1} and ${i2}`),
  1000 * 3,
  'olives',
  'spinash'
);
